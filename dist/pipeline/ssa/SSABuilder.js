import { createPlace } from '../../frontend/ir/utils.js';
...
class SSABuilder {
    ...
    build() {
        ...
        for (const [declarationId, places] of this.moduleUnit.environment
            ...
            while (workList.length > 0) {
                ...
                for (const blockId of frontier) {
                    ...
                    const identifier = createPhiIdentifier(this.moduleUnit.environment, declarationId);
        ...
        for (const phi of phis) {
            ...
            const places = this.moduleUnit.environment.declToPlaces.get(phi.place.identifier.declarationId);
