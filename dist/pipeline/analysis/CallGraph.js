...
class CallGraph {
     ...
     */
    resolveFunctionFromCallExpression(moduleIR, callExpression) {
    ...
    resolveGlobalFunctionCall(global) {
        ...
        const funcDeclInstr = moduleIR.environment.placeToInstruction.get(exportPlace.declaration.place.id);
