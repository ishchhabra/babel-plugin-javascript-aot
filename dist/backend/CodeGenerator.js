...
import { ExpressionInstruction, StatementInstruction, PatternInstruction, JSXInstruction, MiscellaneousInstruction, UnsupportedNodeInstruction, ArrayExpressionInstruction, BinaryExpressionInstruction, CallExpressionInstruction, CopyInstruction, LiteralInstruction, LoadGlobalInstruction, LoadLocalInstruction, LogicalExpressionInstruction, MemberExpressionInstruction, ObjectExpressionInstruction, UnaryExpressionInstruction, IdentifierInstruction, ExportDefaultDeclarationInstruction, ExportNamedDeclarationInstruction, ExportSpecifierInstruction, ExpressionStatementInstruction, FunctionDeclarationInstruction, ImportDeclarationInstruction, StoreLocalInstruction, ArrayPatternInstruction, JSXElementInstruction, JSXFragmentInstruction, JSXTextInstruction, HoleInstruction, ObjectMethodInstruction, ObjectPropertyInstruction, SpreadElementInstruction, ImportSpecifierInstruction } from '../frontend/ir/Instruction.js';
...
class CodeGenerator {
    ...
    #generateIdentifierInstruction(instruction) {
        const node = t.identifier(instruction.name);
        this.places.set(instruction.place.id, node);
        return node;
    }
    ...
    #generateStatement(instruction) {
        if (instruction instanceof ExportDefaultDeclarationInstruction) {
            ...
            return this.#generateExportSpecifier(instruction);
        }
    ...
    #generateExportNamedDeclaration(instruction) {
    ...
    #generateExportSpecifier(instruction) {
        ...
        const exported = t.isValidIdentifier(instruction.exported) ||
    ...
    #generateImportDeclaration(instruction) {
    ...
    #generateImportSpecifier(instruction) {
