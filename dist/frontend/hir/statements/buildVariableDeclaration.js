...
function buildVariableDeclaration(nodePath, functionBuilder, moduleBuilder, environment) {
    ...
    const declarationPlaces = declarations.map((declaration) => {
        ...
        for (const identifier of lvalIdentifiers) {
            functionBuilder.environment.declToDeclInstrPlace.set(identifier.identifier.declarationId, place.id);
        }
        return place;
    });
...
function buildIdentifierVariableDeclaratorLVal(nodePath, functionBuilder, environment) {
    ...
    functionBuilder.environment.declToDeclInstrPlace.set(place.identifier.declarationId, place.id);
