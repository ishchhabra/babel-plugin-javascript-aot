...
function buildFunctionDeclaration(nodePath, functionBuilder, moduleBuilder) {
    ...
    functionBuilder.addInstruction(new FunctionDeclarationInstruction(createInstructionId(functionBuilder.environment), functionPlace, nodePath, identifierPlace, functionIR, nodePath.node.generator, nodePath.node.async));
