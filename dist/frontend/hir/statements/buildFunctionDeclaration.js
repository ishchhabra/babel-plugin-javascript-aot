...
function buildFunctionDeclaration(nodePath, functionBuilder, moduleBuilder) {
    ...
    const functionIR = new FunctionIRBuilder(bodyPath, functionBuilder.environment, moduleBuilder, paramPlaces).build();
    ...
    functionBuilder.currentBlock.instructions.push(new FunctionDeclarationInstruction(createInstructionId(functionBuilder.environment), functionPlace, nodePath, identifierPlace, functionIR, nodePath.node.generator, nodePath.node.async));
