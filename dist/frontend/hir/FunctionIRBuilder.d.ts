...
import { BasicBlock, BlockId, DeclarationId, Place } from "../../ir";
...
export declare class FunctionIRBuilder {
    ...
    constructor(nodePath: NodePath<t.Program | t.BlockStatement>, environment: Environment, moduleBuilder: ModuleIRBuilder);
    build(): FunctionIR;
