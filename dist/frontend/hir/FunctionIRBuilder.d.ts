...
export declare class FunctionIRBuilder {
    ...
    readonly bodyPath: NodePath<t.Program | t.BlockStatement | t.Expression>;
    readonly environment: Environment;
    readonly moduleBuilder: ModuleIRBuilder;
    currentBlock: BasicBlock;
    readonly blocks: Map<BlockId, BasicBlock>;
    readonly header: BaseInstruction[];
    constructor(paramPaths: NodePath<t.Identifier | t.RestElement | t.Pattern>[], bodyPath: NodePath<t.Program | t.BlockStatement | t.Expression>, environment: Environment, moduleBuilder: ModuleIRBuilder);
    build(): FunctionIR;
