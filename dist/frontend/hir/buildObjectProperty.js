...
function buildObjectProperty(nodePath, functionBuilder, moduleBuilder) {
    ...
    functionBuilder.currentBlock.instructions.push(new ObjectPropertyInstruction(makeInstructionId(functionBuilder.environment.nextInstructionId++), place, nodePath, keyPlace, valuePlace, nodePath.node.computed, nodePath.node.shorthand));
    return place;
}
