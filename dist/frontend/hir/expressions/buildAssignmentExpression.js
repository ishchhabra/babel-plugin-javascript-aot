...
function buildAssignmentLeft(leftPath, nodePath, functionBuilder, moduleBuilder, environment) {
    if (leftPath.isIdentifier()) {
        ...
        return buildAssignmentPattern(leftPath, nodePath, functionBuilder, moduleBuilder, environment);
    }
...
function buildAssignmentPattern(leftPath, nodePath, functionBuilder, moduleBuilder, environment) {
