...
function buildFunctionExpression(nodePath, functionBuilder, moduleBuilder, environment) {
    ...
    functionBuilder.addInstruction(new FunctionExpressionInstruction(createInstructionId(environment), place, nodePath, identifierPlace, functionIR, nodePath.node.generator, nodePath.node.async));
    return place;
}
