...
function buildCallExpression(expressionPath, builder) {
    ...
    builder.currentBlock.instructions.push(new CallExpressionInstruction(instructionId, place, expressionPath, calleePlace, argumentPlaces));
    return place;
}
