...
function buildUpdateExpression(nodePath, functionBuilder, moduleBuilder) {
    ...
    const valuePlace = buildBinaryExpression(binaryExpressionPath, functionBuilder, moduleBuilder);
    ...
    functionBuilder.currentBlock.instructions.push(new StoreLocalInstruction(instructionId, place, nodePath, lvalPlace, valuePlace, "const"));
