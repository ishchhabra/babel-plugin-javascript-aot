...
function buildMemberExpression(nodePath, functionBuilder, moduleBuilder) {
    ...
    functionBuilder.currentBlock.instructions.push(new MemberExpressionInstruction(instructionId, place, nodePath, objectPlace, propertyPlace, nodePath.node.computed));
    return place;
}
