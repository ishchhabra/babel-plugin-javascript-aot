...
export declare class ImportDeclarationInstruction extends StatementInstruction {
    ...
    constructor(id: InstructionId, place: Place, nodePath: NodePath<t.Node> | undefined, source: string, specifiers: Place[]);
    rewriteInstruction(): BaseInstruction;
    getReadPlaces(): Place[];
}
...
export declare class LoadGlobalInstruction extends ExpressionInstruction {
    ...
    constructor(id: InstructionId, place: Place, nodePath: NodePath<t.Node> | undefined, name: string, kind: "builtin" | "import");
    rewriteInstruction(): BaseInstruction;
    getReadPlaces(): Place[];
    get isPure(): boolean;
}
