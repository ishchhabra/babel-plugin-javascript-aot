...
class ExportDefaultDeclarationInstruction extends StatementInstruction {
    id;
    place;
    nodePath;
    declaration;
...
class ExportNamedDeclarationInstruction extends StatementInstruction {
    id;
    place;
    nodePath;
    specifiers;
...
class ExportSpecifierInstruction extends StatementInstruction {
    id;
    place;
    nodePath;
    local;
 ...
 *    instruction for "x".
 */
class IdentifierInstruction extends ExpressionInstruction {
    id;
    place;
    nodePath;
    name;
...
class ImportDeclarationInstruction extends StatementInstruction {
    id;
    place;
    nodePath;
    source;
...
class ImportSpecifierInstruction extends MiscellaneousInstruction {
    id;
    place;
    nodePath;
    imported;
...
export { ArrayExpressionInstruction, ArrayPatternInstruction, BaseInstruction, BinaryExpressionInstruction, CallExpressionInstruction, CopyInstruction, ExportDefaultDeclarationInstruction, ExportNamedDeclarationInstruction, ExportSpecifierInstruction, ExpressionInstruction, ExpressionStatementInstruction, FunctionDeclarationInstruction, HoleInstruction, IdentifierInstruction, ImportDeclarationInstruction, ImportSpecifierInstruction, JSXElementInstruction, JSXFragmentInstruction, JSXInstruction, JSXTextInstruction, LiteralInstruction, LoadGlobalInstruction, LoadLocalInstruction, LogicalExpressionInstruction, MemberExpressionInstruction, MiscellaneousInstruction, ObjectExpressionInstruction, ObjectMethodInstruction, ObjectPropertyInstruction, PatternInstruction, SpreadElementInstruction, StatementInstruction, StoreLocalInstruction, UnaryExpressionInstruction, UnsupportedNodeInstruction, makeInstructionId };
