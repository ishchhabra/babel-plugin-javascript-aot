...
class ImportDeclarationInstruction extends StatementInstruction {
    ...
    source;
    specifiers;
    constructor(id, place, nodePath, source, specifiers) {
        super(id, place, nodePath);
        this.id = id;
        this.place = place;
        this.nodePath = nodePath;
...
class LoadGlobalInstruction extends ExpressionInstruction {
    ...
    name;
    kind;
    constructor(id, place, nodePath, name, kind) {
        super(id, place, nodePath);
        this.id = id;
        this.place = place;
        this.nodePath = nodePath;
