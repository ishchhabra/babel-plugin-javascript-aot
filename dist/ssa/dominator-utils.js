 ...
 */
function getDominators(predecessors, entryId) {
 ...
 */
function getDominanceFrontier(predecessors, iDom) {
...
export { getDominanceFrontier, getDominators, getImmediateDominators };
