import { makeInstructionId, StoreLocalInstruction, LoadLocalInstruction, CopyInstruction, ExpressionStatementInstruction } from '../ir/Instruction.js';
...
class SSAEliminator {
    ...
    blocks;
    phis;
    constructor(environment, blocks, phis) {
