...
class JSXElementInstruction extends JSXInstruction {
    ...
    rewriteInstruction(values) {
        return new JSXElementInstruction(this.id, this.place, this.nodePath, values.get(this.openingElement.identifier.id) ?? this.openingElement, values.get(this.closingElement.identifier.id) ?? this.closingElement, this.children.map((child) => values.get(child.identifier.id) ?? child));
    }
    getReadPlaces() {
...
class JSXFragmentInstruction extends JSXInstruction {
    ...
    rewriteInstruction(values) {
        return new JSXFragmentInstruction(this.id, this.place, this.nodePath, this.openingFragment, this.closingFragment, this.children.map((child) => values.get(child.identifier.id) ?? child));
    }
    getReadPlaces() {
