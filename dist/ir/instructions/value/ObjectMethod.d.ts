...
export declare class ObjectMethodInstruction extends ValueInstruction {
    ...
    constructor(id: InstructionId, place: Place, nodePath: NodePath<t.Node> | undefined, key: Place, params: Place[], body: FunctionIR, computed: boolean, generator: boolean, async: boolean, kind: "method" | "get" | "set");
